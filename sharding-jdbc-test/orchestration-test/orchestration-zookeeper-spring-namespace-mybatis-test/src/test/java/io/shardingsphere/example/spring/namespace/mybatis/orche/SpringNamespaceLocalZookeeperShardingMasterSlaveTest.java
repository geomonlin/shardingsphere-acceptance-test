...
@ContextConfiguration("/META-INF/zookeeper/local/application-sharding-master-slave.xml")
public class SpringNamespaceLocalZookeeperShardingMasterSlaveTest extends SpringNamespaceBaseTest {
